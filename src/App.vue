...
<template>
  <div class="d-flex flex-column d-print-block overflow-hidden">
    <div class="topBar bg-dark text-light row align-items-center g-0 d-print-none shadow z-3">
      <div class="col d-none align-items-center d-lg-flex">
      ...
      <div class="col d-none align-items-center justify-content-end p-0 d-lg-flex">
        <button type="button" class="btn btn-dark me-1 p-1" @click="openModal('about')"
          style="--bs-btn-padding-y: .25rem; --bs-btn-padding-x: .5rem; --bs-btn-font-size: .75rem;">
          情報
        </button>
        <button type="button" class="btn btn-dark me-1 p-1" @click="saveData()"
          style="--bs-btn-padding-y: .25rem; --bs-btn-padding-x: .5rem; --bs-btn-font-size: .75rem;">
          保存
        </button>
        <button type="button" class="btn btn-dark me-1 p-1" @click="openModal('load')"
          style="--bs-btn-padding-y: .25rem; --bs-btn-padding-x: .5rem; --bs-btn-font-size: .75rem;">
          読み込み
        </button>
        <button type="button" class="btn btn-dark me-1 p-1" @click="openModal('print')"
          style="--bs-btn-padding-y: .25rem; --bs-btn-padding-x: .5rem; --bs-btn-font-size: .75rem;">
          印刷
        </button>
