...
function defaultSectionData() {
  return {
    ...
    meigenOffset: { formName: "名言位置調整", formType: shallowRef(FormRange), formArgs: { min: -100, max: 100, step: 0.5 }, data: 0 },
  ...
  sections: {
    "general": {
      ...
      sectionData: {
        ...
        font: { formName: "フォント", formType: shallowRef(FormSelect), formArgs: { items: fontNames, values: fontNames }, data: "Shippori Mincho" },
